...
const Page:React.FC<pageProps> = () => {
  ...
  return<>
  <div className="bg-black flex h-screen w-screen items-center text-white text-left text-2xl font-medium justify-center overflow-auto">
